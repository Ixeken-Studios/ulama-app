package com.ixeken.worldcupinfo.ui.theme
...
/**
 * Tema de la aplicación adaptado a la guía de estilo de Material Design 3 Expressive.
 */
@Composable
fun WorldCupInfoTheme(
    darkTheme: Boolean = isSystemInDarkTheme(),
    fontStyle: String = "space_grotesk",
    ...
    MaterialTheme(
        ...
        typography = getTypography(fontStyle),
        content = content
    )
}